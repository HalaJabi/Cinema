...
public class addmove {
    ...
    public void cbutton(ActionEvent actionEvent) {
        ...
        try {
            ...
            String s="insert into MOVES values('"+id.getText()+"','"+name.getText()+"','"+type.getText()+"','"+year.getText()+"','"+rate.getText()+"','"+actor.getText()+"')";
            //  String s="insert into visitor values('1122','AHMAD JABE','5555','11-May-2015','Nablus','0598112808')";
            JOptionPane.showMessageDialog(null,"you add new move");
            stm.executeUpdate(s);
            con.commit();
            con.close();
        }
